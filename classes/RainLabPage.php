...
use RainLab\Pages\Classes\PlaceholderList;
 ...
 */
class RainLabPage extends Content
{
    /**
    ...
    {
        $pages = RainLabPage::listInTheme($this->theme, true);
    ...
    public function save()
    {
        ...
        if ($isNewFile) {
            ...
            $this->fileName = \Str::ascii($curName);
        }
