<?php namespace RtlWeb\Persian\FormWidgets;
...
class DatePicker extends FormWidgetBase
{
    ...
    public function prepareVars()
    {
        ...
        if ($value = $this->getLoadValue()) {
            ...
            if ($this->mode == 'datetime') {
                ...
                $value = $dateTime[0];
                $this->vars['timeValue'] = isset($dateTime[1]) ? mb_substr($dateTime[1], 0, 5) : '';
            } /*
             * Date
             */
    ...
    public function loadAssets()
    {
        ...
        $this->addCss('vendor/jquery.calendars/css/jquery.calendars.picker.css', 'core');
        $this->addCss('vendor/jquery.calendars/css/redmond.calendars.picker.css', 'core');
        $this->addCss('css/datepicker.css', 'core');
//        $this->addJs('js/build-min.js', 'core');
//        $this->addJs('vendor/moment/moment.js', 'core');
        $this->addJs('vendor/jquery.calendars/js/jquery.plugin.min.js', 'core');
        $this->addJs('vendor/jquery.calendars/js/jquery.calendars.all.min.js', 'core');
        $this->addJs('vendor/jquery.calendars/js/jquery.calendars.picker.ext.min.js', 'core');
        $this->addJs('vendor/jquery.calendars/js/jquery.calendars.persian.min.js', 'core');
        $this->addJs('vendor/jquery.calendars/js/jquery.calendars.persian-fa.js', 'core');
        $this->addJs('vendor/jquery.calendars/js/jquery.calendars.picker-fa.js', 'core');
